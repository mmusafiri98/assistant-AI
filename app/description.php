    ...
    <div class="container">
        <div class="card">
            ...
            <div class="content">
                ...
                <button>
                    <a href="french.php">Commencer l'apprentissage</a>
                </button>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="content">
                ...
                <button>
                    <a href="eng.php">Commencer l'apprentissage</a>
                </button>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="content">
                ...
                <button>
                    <a href="japan.php">Commencer l'apprentissage</a>
                </button>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="content">
                ...
                <button>
                    <a href="italie.php">Commencer l'apprentissage</a>
                </button>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="content">
                ...
                <button>
                    <a href="Allemagne.php">Commencer l'apprentissage</a>
                </button>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="content">
                ...
                <button>
                    <a href="China.php">Commencer l'apprentissage</a>
                </button>
            </div>
        </div>
    </div>
