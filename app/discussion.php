...
<body>
    <video id="full-video" loop muted playsinline autoplay>
        <source src="discussion.mp4" type="video/mp4" />
        <source src="discussion.webm" type="video/webm" />
    ...
    <script>
        ...
        function initSpeechRecognition() {
            ...
            recognition.onend = () => {
                if (isListening) recognition.start(); // redémarrage auto si le micro doit rester actif
